 ...
 */
package com.reus.download.util;
...
/**
 * @version $Id: CustomRedirectStrategy.java, v 0.1 2018-09-18 reus Exp $
 * @ClassName: CustomRedirectStrategy
 * @Description:支持post 302跳转策略实现类,HttpClient默认跳转：
